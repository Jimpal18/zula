...
const WhyChoose = () => {
  ...
  return (
    <div className="bg-amber-50 px-4 py-0 md:px-8 lg:px-16 pb-20" ref={inViewRef}>
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative">
          <motion.div
            ...
            className="flex overflow-x-auto gap-8 md:gap-5 py-6 no-scrollbar"
            style={{
              scrollbarWidth: 'thin',
          ...
          >
            ...
            {imageDetails.map((item, index) => {
              ...
              return (
                <motion.div
                  key={index}
                  className="relative w-[350px] md:w-[300px] h-[320px] rounded-4xl overflow-hidden shadow-lg group flex-shrink-0"
